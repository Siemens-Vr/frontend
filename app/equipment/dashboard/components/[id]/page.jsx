            ...
            <tbody>
              {componentsWithoutPartNumbers.map((component, index) => (
                <tr key={index}>
                  ...
                  <Link href={`/equipment/dashboard/components/single/${component.uuid}`}>
                      <button className={styles.button}>View</button>
                    </Link>
                    <button className={styles.button} onClick={() => handleAddQuantity(component)}>
                      AddQ
                    </button>
                    <Link href={`/equipment/dashboard/borrow/add?id=${component.uuid}`}>
              ...
              {componentsWithPartNumbers.map((component, index) => (
                <tr key={index}>
                  ...
                  <td className={styles.buttons}>
                    <Link href={`/equipment/dashboard/components/single/${component.uuid}`}>
                      <button className={styles.button}>View</button>
                    </Link> <Link href={`/equipment/dashboard/borrow/add?id=${component.uuid}`}>
                      <button className={styles.button}>Borrow</button>
                    </Link>
