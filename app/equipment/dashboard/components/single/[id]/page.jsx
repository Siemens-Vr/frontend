...
import UpdatePopUp from '../../../../ui/dashboard/update/update';
  ...
  return (
    <div className={styles.container}>
      <div className={styles.historyButtons}>
        <Link href={`/equipment/dashboard/components/borrow-history/${id}`}>
          <button className={styles.historyButton}>View Borrow History</button>
        </Link>
        <Link href={`/equipment/dashboard/components/product-history/${id}`}>
