"use client"
import styles from "../../ui/dashboard/components/components.module.css"
import Search from "../../ui/dashboard/search/search"
import { Suspense } from "react"
import Link from "next/link"
import { useParams } from 'next/navigation'
import React, { useEffect, useState } from 'react'
import CategoriesPopUp from "../../ui/dashboard/categories/categories"
  ...
  return (
    <div className={styles.container}>
      ...
      <Search placeholder="search for components" />
        ...
        <Link href="/equipment/dashboard/components/add">
        ...
        <tbody>
          {components.map((component, index) => (
            <tr key={index}>
              ...
              <td>
                <Link href={`/equipment/dashboard/components/${component.componentType}`}>
