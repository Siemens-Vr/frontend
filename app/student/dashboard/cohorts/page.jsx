...
import CohortEditPopup from "../../ui/dashboard/cohorts/components/CohortEditPopup";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.top}>
        <Link href="/student/dashboard/cohorts/add">
            ...
            <tr key={cohort.id}>
              ...
              <td>
                <div className={styles.buttons}>
                  <Link href={`/student/dashboard/cohorts/${cohort.uuid}`}>
